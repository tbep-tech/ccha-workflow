...
treeplo1 <- reactive({
  ...
  out <- treesum_plo(treedat, sitsel3, byspecies = aggsel, zonefct = zonsel3, tresel = tresel, var = varsel2, dodge = dgesel, thm = thm)
...
fillCol(flex = c(NA, 1),
  column(12, 
    column(3, selectInput('spptyp1', 'Select species by:', choices = c('Top n', 'Names'), width = '100%')), 
    column(3, 
      renderUI({

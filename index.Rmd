...
vegplo2 <- reactive({
  ...
  out <- sitesum_plo(vegdat, sitsel2, delim = metsel, delimtyp = dlmtyp, top = topsel, var = varsel1, zonefct = zonsel2, thm = thm)
...
fillCol(flex = c(NA, 1),
  column(12, 
    column(4, sliderInput('topsel', 'Select number of species:', min = 1, max = 30, step = 1, value = 10, width = '100%')),
    column(4, selectInput('dlmtyp', 'Select bins by:', choices = c('Number', 'Distance'), width = '100%')), 
    column(4, 
      renderUI({

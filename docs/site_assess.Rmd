...
Same thing by as percent basal cover.
...
A plot of sum of percent basal cover by arbitrary meter markings, top species, and for a select zone.

```{r, height = 8, width = 8}
sitesum_plo(cchadat, site, delim = 10, top = 8, zone_name = 'Mangrove Fringe')
```

...
#| fig-height: 6
#| fig-width: 9
#| fig-cap: "Vegetation zones and elevations along transects by sites in Tampa Bay, Florida. Black lines indicate projected sea level rise by 2060 under high and intermediate scenarios [@sweet2022].  Shaded gray area indicates existing sea level rise from historical tidal gauge data."
...
lns <- tibble(
  Scenario = c('High SLR 2060', 'Intermediate SLR 2060'),
  elev = c(0.73, 0.48)
)
